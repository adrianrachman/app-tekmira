...
<<<<<<< HEAD
                <img v-if="$route.path.includes('/meeting')"  :src="require('@/assets/images/ra1.png')" class="object-cover rounded-xl md:rounded-none md:rounded-r-xl w-full md:w-[80%] h-[500px]" />
                <img v-else-if="$route.path.includes('/wedding')"  :src="require('@/assets/images/sm1.png')" class="object-cover rounded-xl md:rounded-none md:rounded-r-xl w-full md:w-[80%] h-[500px]" />
                <img v-else-if="$route.path.includes('/tenis')"  :src="require('@/assets/images/tns1-1.png')" class="object-cover rounded-xl md:rounded-none md:rounded-r-xl w-full md:w-[80%] h-[500px]" />
                <img v-else-if="$route.path.includes('/wisma')"  :src="require('@/assets/images/w4-1.png')" class="object-cover rounded-xl md:rounded-none md:rounded-r-xl w-full md:w-[80%] h-[500px]" />
=======
...
>>>>>>> 82666e5 (edit foto)
        >
          ...
          class="relative w-full rounded-2xl bg-no-repeat bg-cover bg-center h-[180px]"
<<<<<<< HEAD
          :style="{ backgroundImage: `url(${require('@/assets/images/bh1.png')})`, boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)' }"
=======
